...
String rrPath = "/respirationrate";
String spoPath = "/spo2";
String sysPath = "/systolik";
String diaPath = "/diastolik";
    ...
    if(hr > 50000 && umurTersimpan == false){
      ...
      if(currentTime - startTime >= duration) {
        ...
        if(currentTime - startTime <= duration + 200){
          ...
          json.set(sysPath.c_str(), String(sistolik));
          json.set(diaPath.c_str(), String(diastolik));
